...
describe("DomVDomConverter", () => {
    ...
    describe("createDomFromVDom", () => {
        ...
        it("should throw error for unknown VDomNode type", () => {
            ...
            expect(() => DomVDomConverter.createDomFromVDom(vdom)).toThrow(
                "Unknown vdom node type: root"
            );
        });
    });

    describe("createDomTreeFromVDomTree", () => {
        it("should create complete DOM tree from VDOM tree", () => {
            ...
            const domRoot =
                DomVDomConverter.createDomTreeFromVDomTree(vdomRoot);
    ...
    describe("createVDomFromElement", () => {
        ...
        it("should throw error for span with null textContent", () => {
            ...
            expect(() =>
                DomVDomConverter.createVDomFromElement(element)
            ).toThrow("textContent is null");
        });
        ...
        it("should throw error for unknown element type", () => {
            ...
            expect(() =>
                DomVDomConverter.createVDomFromElement(element)
            ).toThrow("Unknown element type: DIV");
        });
    });
    ...
    describe("createVDomTreeFromElement", () => {
        it("should create complete VDOM tree from DOM element", () => {
            ...
            const vdomRoot =
                DomVDomConverter.createVDomTreeFromElement(rootElement);
